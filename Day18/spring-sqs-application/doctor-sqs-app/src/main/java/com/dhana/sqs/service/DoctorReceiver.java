...
public class DoctorReceiver {
    private static final Logger logger = LoggerFactory.getLogger(DoctorReceiver.class);

    private final SqsAsyncClient sqsAsyncClient;
    private final ObjectMapper objectMapper;

    public DoctorReceiver(SqsAsyncClient sqsAsyncClient, ObjectMapper objectMapper) {
    ...
    public <T> Pair<T, Map<String, MessageAttributeValue>> consumeMessage(String queueName, Class<T> messageType) throws ExecutionException, InterruptedException, JsonProcessingException {
    ...
    public void deleteFromQueue(String queueName, Message message) throws ExecutionException, InterruptedException {
        ...
        logger.info("Message Delete Response:{}", deleteMessageResponse);
    }
}
